...
2. Verify: Upon receipt of an encrypted share, an Aggregator decrypts the share,
   ...
   to system security properties is in [[TODO:citeme]].)
...
paper and {{?BBCp19=DOI.10.1007/978-3-030-26954-8_3}} --- considers **either** a malicious client (attacking
...
techniques in {{BBCp19}} that account for this; we need to figure out if they're
practical.]]
...
validity circuits with G-gates, a la {{BBCp19}}, Theorem 4.3.]]
